...
Europe'
      text: |-
        My dissertation titled **'Divided over Democracy: The effects of Affective Polarization on Citizens' Democratic Support'** is funded by the <a href="https://www.fwo.be/en/">Research Foundation Flanders (FWO)</a> under a four-year fundamental research fellowship (2023-2027). Read the abstract of the dissertation below. <p style="color: #67e8f9">Supervisors & Doctoral Advisory Committee</p> Prof. dr. Anna Kern (supervisor), Prof. dr. Hannah Werner (co-supervisor), Prof. dr. Suthan Krishnarajan, Prof. dr. Yphtach Lelkes, & Prof. dr. Markus Wagner. <p style="color: #67e8f9">Abstract</p>
